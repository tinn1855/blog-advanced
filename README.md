...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/BZAbpWKdAs)
...
```sh
npx nx serve blog-advanced
```

To create a production bundle:

```sh
npx nx build blog-advanced
```

To see all available targets to run for a project, run:

```sh
npx nx show project blog-advanced
```
